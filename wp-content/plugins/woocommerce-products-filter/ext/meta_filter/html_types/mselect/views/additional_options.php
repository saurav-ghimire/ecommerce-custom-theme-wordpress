...
<input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][options]" value="<?php echo esc_html(isset($settings[$key]['options']) ? $settings[$key]['options'] : "") ?>" /> 
<input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][search_logic]" value="<?php echo esc_html(isset($settings[$key]['search_logic']) ? $settings[$key]['search_logic'] : "OR") ?>" /> 
